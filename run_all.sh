...
# 1. 드라마 이름 변경
/volume1/web/video_auto/drama_name.sh || echo "drama_name.sh 실행 중 오류 발생 (계속 진행)"
...
# 4. bt4g
/volume1/web/Python/bt4g/bt4g.sh || echo "bt4g.sh 실행 중 오류 발생 (계속 진행)"

# 5. photo_move
/volume1/web/video_auto/photo_move.sh || echo "photo_move.sh 실행 중 오류 발생 (계속 진행)"

# 6. speedtest
/volume1/web/Python/speedtest/speedtest.sh || echo "speedtest.sh 실행 중 오류 발생 (계속 진행)"
